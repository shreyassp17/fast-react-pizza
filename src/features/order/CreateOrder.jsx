      ...
      <Form method="POST">
        ...
        <div className="relative mb-5 flex gap-2 flex-col sm:flex-row sm:items-center">
          ...
          <div className="grow">
            ...
            {addressStatus === 'error' && <p className="text-xs mt-2 text-red-700 p-2 bg-red-100 rounded-md">{errorAddress}</p>}
          </div>
...
export async function action({ request }) {
  ...
  //useNavigate hook can only be called inside components
